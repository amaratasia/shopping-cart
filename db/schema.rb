...
ActiveRecord::Schema.define(version: 2020_09_14_114749) do
  ...
  create_table "product_promotions", force: :cascade do |t|
    ...
    t.index ["promotion_category_id"], name: "index_product_promotions_on_promotion_category_id"
  end
  ...
  add_foreign_key "product_promotions", "promotion_categories"
end
